                ...
                {bannerList && bannerList.map((banner) => (
                    <div key={banner.id} className='min-w-full min-h-[450px] lg:min-h-full overflow-hidden relative group transition-all' style={{ transform: `translateX(-${currentImage * 100}%)` }}>
                        ...
                        <div className='container mx-auto w-full absolute lg:left-10 bottom-10 max-w-3xl px-4'>
                            ...
                            <button className='bannerButton bg-neon-red lg:px-10 lg:py-3 rounded mt-5 hover:text-neon-yellow hover:bg-gradient-to-r from-neon-red to-neon-blue shadow-md transition-all hover:scale-105 px-4 py-1 md:px-7 md:py-2 drop-shadow-2xl'>
                                Play Now
                            </button>
                        </div>
                    </div>
